...
export const metadata: Metadata = {
  title: "SportZone Pro - Premier Sport Facility & Training Center",
  description: "State-of-the-art sport facility with professional coaching, modern equipment, and world-class training programs. Join 5000+ athletes achieving peak performance.",
  keywords: "sport facility, fitness center, professional coaching, athletic training, gym equipment, swimming pool, basketball courts, tennis courts",
  metadataBase: new URL("https://sportzonepr.com"),
  alternates: {
    canonical: "https://sportzonepr.com"
  },
  openGraph: {
    title: "SportZone Pro - Premier Sport Facility & Training Center",
    description: "State-of-the-art sport facility with professional coaching and world-class training programs",
    siteName: "SportZone Pro",
    images: [
      {
        url: "https://images.pexels.com/photos/9787275/pexels-photo-9787275.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "Modern sport facility interior"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "SportZone Pro - Premier Sport Facility",
    description: "Professional sport facility with modern equipment and expert coaching",
    images: ["https://images.pexels.com/photos/9787275/pexels-photo-9787275.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
